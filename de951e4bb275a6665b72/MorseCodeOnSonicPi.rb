...
msg = "Sonic-Pi 2 is a great program for the Rasberry Pi." #the message to be sent
...
ws = 7 * sp -cs # gap between characters cs already included by the program so subtract it
pt = :c5 #note pitch
...
define :playarray do |narray,darray,shift=0,vol=1,voice = :saw|
  with_synth voice do
 ...
 playarray(note.flatten,dur.flatten,12) #remove remaining [] and send arrays to playarray
