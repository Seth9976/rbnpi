...
#amended to handle new thread strucutre in SP2.11dev
use_debug false
...
killit = 0 #used to kill live_loop :t when samples all loaded
define :load do |i|
  trigger=0
  live_loop :t do
    ...
    stop if killit == 1 #stop loop once all samples laoded
  end
...
killit = 1 #set flag to kiil live_loop :t
