#Sonic Pi Loop Controller4 by Robin Newman
#VERSION 2 ADDS CONTROL OF BACKGROUND PULSE AND SCREEN
#THIS VERSION updated for OSC changed for Sonic Pi ver 3.3 and 4 onwards Dec 2022
# sync "/osc/.... chamged to sync "/osc*/....
#
#The TouchOSC file will load into latest TouchOSC and will be converted there
#
...
use_real_time
sleep 1
use_osc "192.168.1.205",9000 #adjust for output IP to which to send LED on/off signals (TouchOSC)
use_bpm 120
