...
USE SPloopController4.rb for SP versions 3.31, or 4 or greater.
YOu can use the new version of TouchOSC see later in the ReadMe file.
...
Loop.Control.touchosc  YOu can then load it into the TouchOSC editor and send it via WiFi to the tablet or phone with TouchOSC You can also load it into TouchOSC MkII where it will be converted to suit the new format. If you save it there the file will change and have new suffix .tosc instead of .touchosc
...
USE THE SEPARATE VERSION FOR PI3. Differences: slightly less agressive timings in the functions and live loops
