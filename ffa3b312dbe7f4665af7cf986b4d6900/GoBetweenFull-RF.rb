#The theme from the Film The Go Between 1971 by Michel Legrand
#arranged for Sonic Pi 2.11 by Robin Newman, November 2016
#I transcribed the music by ear from a YouTube recording by Jerome Allain, utilising Audacity to play
...
#to play in a buffer
#The Sonatina Library should be downloaded from http://sso.mattiaswestlund.net/ 
...
plarray(a1[i],b1[i],c1[i],"Grand Piano",1) #|notes,durations,offsetclass,tp=0,pan=0,vol=1,s=0.9,r=0.1|
end
end
...
plarray(a2[i],b2[i],c2[i],"Grand Piano",1) #|notes,durations,offsetclass,tp=0,pan=0,vol=1,s=0.9,r=0.1|
end
end
end #reverb